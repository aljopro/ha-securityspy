...
- [SecuritySpy OpenAPI description](https://github.com/aljopro/aiosecurityspy/blob/main/docs/securityspy-openapi.yaml) (in the standalone `aiosecurityspy` repo) — machine-readable description of the HTTP calls, with explicit annotations for the parts OpenAPI cannot express
