...
- [SecuritySpy OpenAPI description](securityspy-openapi.yaml) — machine-readable description of the HTTP calls, with explicit annotations for the parts OpenAPI cannot express
